                ...
                <div class="flex">
                    ...
                    <div class="w-full p-8">
                        <div class="flex justify-between">
                            <div>
                                <h3 class="text-2xl text-grey-darkest font-medium">Siren Midi Player</h3>
                                <p class="text-sm text-grey mt-1">Octaves</p>
                            </div>
                            <div class="text-red-lighter">
                                <svg class="w-6 h-6 cursor-pointer" fill="currentColor"
                        ...
                        <div class="flex justify-between items-center mt-8">
                            <div class="text-grey-darker">
                                <svg class="w-8 h-8 cursor-pointer" fill="currentColor"
                                     xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 20 20">
                                    <path
                            ...
                            <div class="text-orange p-8 rounded-full bg-red-900 shadow-lg" @click="play">
                                <ion-icon name="play-outline" class="text-6xl cursor-pointer block"></ion-icon>
                            </div>
                            <div class="text-grey-darker">
                                <svg class="w-8 h-8 cursor-pointer" fill="currentColor"
                                     xmlns="http://www.w3.org/2000/svg"
...
export default {
    ...
    mounted: async() => {
        const url = axios.defaults.baseURL + "/Octave.mid";
